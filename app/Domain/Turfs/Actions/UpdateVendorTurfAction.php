...
final class UpdateVendorTurfAction
{
    ...
    public function execute(
        ...
        DB::transaction(function () use ($turf, $attributes, $sportIds, $amenityIds, $images, $rules): void {
            $this->turfs->update($turf, $attributes);
        ...
        return $turf->refresh()->load(['location.vendor', 'sports', 'amenities', 'images.file', 'rules']);
    }
}
